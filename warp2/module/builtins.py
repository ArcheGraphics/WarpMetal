...
from warp2.module.context import add_builtin
from warp2.codegen.reference import Reference
...
add_builtin(
   ...
   This is the most intuitive form of rounding in the colloquial sense, but can be slower than other options like :func:`warp2.rint()`.
...
add_builtin(
   ...
   It is generally faster than :func:`warp2.round()`. Equivalent to :func:`numpy.rint()`.""",
)
...
add_builtin(
    "argmin",
    input_types={"v": vector(length=Any, dtype=Scalar)},
    value_func=lambda arg_types, kwds, _: warp2.uint32,
...
add_builtin(
   ...
   Interpolation should be :attr:`warp2.Volume.CLOSEST` or :attr:`wp.Volume.LINEAR.`""",
)
