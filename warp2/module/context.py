...
from warp2.module.kernel import Kernel
from warp2.module.module import Module
...
def add_builtin(
    ...
    # hard coded types. We do this so you can use hard coded warp2 types outside kernels:
